...
public class QiniuCloudUtil {
    ...
    // 设置需要操作的账号的AK和SK
    private static final String ACCESS_KEY = "KbksQnNtkN4nx-ZucM_sz5D-8UIpknbs7twGyTY_";
 ...
 //   private static final String style = "自定义的图片样式";
    ...
    public void delete(String key) throws IOException {
        ...
        // 此处的26是去掉：ongsua0j7.bkt.clouddn.com/,剩下的key就是图片在七牛云的名称
        key = key.substring(26);
        try {
            // 调用delete方法移动文件
